...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 24000,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 480,						-- Days of client lag for pause of gamespeed.
...
NProduction = {
	...
	MAX_CIV_FACTORIES_PER_LINE = 10,	-- Max number of factories that can be assigned a single production line.
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 72,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 96,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 7,				-- how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
...
NAir = {
	...
	AIR_WING_MAX_SIZE = 800, 							-- Max amount of airplanes in wing
...
NNavy = {
	...
	NAVAL_COMBAT_RESULT_TIMEOUT_YEARS = 0.5,							-- after that many years, we clear the naval combat results, so they don't get stuck forever in the memory.
	CONVOY_LOSS_HISTORY_TIMEOUT_MONTHS = 1,						-- after this many months remove the history of lost convoys to not bloat savegames and memory since there is no way to see them anyway
